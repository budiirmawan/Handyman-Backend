...
before(async () => {
  ...
  await runSeeds(pool);
  await pool.query(
    'TRUNCATE handyman_work_sessions, handyman_visit_presence, handyman_visit_arrivals, handyman_service_visit_schedules, handyman_service_visits, handyman_job_assignments, handyman_jobs, handyman_work_crew_members, handyman_work_crews, handyman_providers',
  );
