...
async function fixture() {
  ...
  // CR-BE-CUR-02: PO issuance validates the transaction currency against the
  // client's authoritative monetary context (active + allowed). Provision
  // IDR — the fixture's intended PO currency — via the governed service.
